...
from graph_env.env.utils.networks.influence_l_dgn import LDGNNetwork
...
def get_agents(
    ...
    """
    env = get_env(number_of_agents=args.n_agents, scripted_agents_ratio=args.scripted_agents_ratio, influence_env=True)
