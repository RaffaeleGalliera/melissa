...
def get_args() -> argparse.Namespace:
    ...
    parser.learning_algorithm = "lstm_hl_dgn"
    return parser
...
def watch(
    ...
    weights_path = os.path.join(args.logdir, "mpr", "lstm_hl_dgn", "weights", f"{args.model_name}")
...
def train_agent(
    ...
    if not args.optimize:
        ...
        logger.load(writer)
    weights_path = os.path.join(args.logdir, "mpr", "lstm_hl_dgn", "weights")
