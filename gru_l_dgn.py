...
def get_args() -> argparse.Namespace:
    ...
    parser.learning_algorithm = "gru_l_dgn"
    return parser
...
def watch(
    ...
    weights_path = os.path.join(args.logdir, "mpr", "gru_l_dgn", "weights", f"{args.model_name}")
...
def train_agent(
    ...
    if not args.optimize:
        ...
        logger.load(writer)
    weights_path = os.path.join(args.logdir, "mpr", "gru_l_dgn", "weights")
