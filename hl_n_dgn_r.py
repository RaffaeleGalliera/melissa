...
def get_args() -> argparse.Namespace:
    ...
    parser.learning_algorithm = "hl_n_dgn_r"
    return parser
...
def watch(
    ...
    weights_path = os.path.join(args.logdir, "mpr", "hl_n_dgn_r", "weights", f"{args.model_name}")
...
def train_agent(
    ...
    if not args.optimize:
        ...
        logger.load(writer)
    weights_path = os.path.join(args.logdir, "mpr", "hl_n_dgn_r", "weights")
